...
(deffunction heuristico1(?blancas ?negras ?color)
    (return (random 1 100))
)

(deffunction heuristico2(?blancas ?negras ?color)
    (return (random 1 100))
)

(deffunction heuristico3(?blancas ?negras ?color)
    (return (random 1 100))
)

(deffunction heuristico4(?blancas ?negras ?color)
    (return (random 1 100))
)

(deffunction JUEGO::heuristico(?blancas ?negras ?color)
    ; TODO cambiar heurísticos aquí
    (if ?color then
        ; heurístico para las blancas

        (return (heuristico1 ?blancas ?negras ?color))
        ; (return (heuristico2 ?blancas ?negras ?color))
        ; (return (heuristico3 ?blancas ?negras ?color))
        ; (return (heuristico4 ?blancas ?negras ?color))
    else
        ; heurístico para las negras
